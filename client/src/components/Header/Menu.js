...
import { FaHome, FaPlus, FaTrashAlt, FaFolderOpen, FaSearchLocation } from 'react-icons/fa';
...
function buildMenuButtons(props) {
	return [
		...
		new MenuButtonProps('find-place-button', props.toggleFindPlace, <FaSearchLocation />, 'Find Place'),
